...
{   
	...
	{ 
	 ...
	 Console con=System.console(); // console is a class which is being used here so that when the user enters the word to be guessed then it doesn't shows up on the console 
class Game
{ 
public static void main(String arg[]) throws Exception
{   
